...
class TurtlesimVisualizer(Node):
    def __init__(self):
        ...
        self.create_subscription(VehiclePosition, '/vehicle_position', self.handle_vehicle_pos, 10)
        self.create_subscription(Pose, '/turtle1/pose', lambda msg: self.save_pose('turtle1', msg), 10)
        self.create_subscription(Pose, '/turtle2/pose', lambda msg: self.save_pose('turtle2', msg), 10)
        self.create_subscription(Pose, '/turtle3/pose', lambda msg: self.save_pose('turtle3', msg), 10)
