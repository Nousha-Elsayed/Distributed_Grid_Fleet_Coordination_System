...
class MonitorNode(Node):
    def __init__(self):
        ...
        self.create_subscription(VehicleState, "/vehicle_state", self.handle_vehicle_state, 10)
        self.create_subscription(CompletedTasks, "/completed_tasks", self.handle_completed_tasks, 10)
